...
const MetadataView = () => {
    ...
    const handleFetchMetadata = async () => {
        ...
        try {
            ...
            // Using a CORS proxy to help with potential IPFS fetching issues
    ...
    return (
        // Use a React Fragment <> to wrap the Header and main content
        <>
            {/* The Header is now safely inside the client-only component */}
